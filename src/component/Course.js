  ...
  <div className=" my-5">
    <div className="col-lg-12 text-center">
      ...
      <p className="subtitle-01">
        Suspendisse sodales arcu velit, non pretium massa accumsan non. Proin
        accumsan placerat mauris sit <br />
        amet condimentum. Morbi luctus risus tincidunt urna hendrerit mollis.
      </p>
    </div>
  </div>
  {/* section1 end  */}
                ...
                <div className="card" style={{ width: "18rem" }}>
                  ...
                  <div className="card-body">
                    <div className="product-list__content">
                      <a className="product-list__category" href="#">
                        Economy
                      </a>
